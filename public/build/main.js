...
var ChoresProvider = (function () {
    // status:
    // http://sumsiapi-env.n2eirghx2d.eu-central-1.elasticbeanstalk.com/api/ledgers/1
    function ChoresProvider(http) {
        this.http = http;
        this.apiString = "http://default-environment.ad9m43c3dn.us-east-1.elasticbeanstalk.com/api/ledgers/1";
    }
